...
export function AuroraBackground({
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      const colors = isDark
        ? [
            { color: "rgba(96, 165, 250, 0.2)", x: 0.2, y: 0.3 },
            { color: "rgba(251, 146, 60, 0.15)", x: 0.7, y: 0.5 },
            { color: "rgba(139, 92, 246, 0.12)", x: 0.5, y: 0.7 },
          ]
        : [
            { color: "rgba(59, 130, 246, 0.12)", x: 0.2, y: 0.3 },
            { color: "rgba(251, 146, 60, 0.1)", x: 0.7, y: 0.5 },
            { color: "rgba(99, 102, 241, 0.08)", x: 0.5, y: 0.7 },
          ];
